...
//		private var xRay:Class;
		...
		//public static const COORDS_PATH:String = "..//data//coordinates.txt";
		...
		*/
		private function initStage():void
		{
			...
			// allocates next stage3D for your rendering 
		...
		*/
		...
		{
			// initialize texture 
			//material = new TextureMaterial(Cast.bitmapTexture(xRay)); //INSERTS XRAY IMAGE!!!
		...
		private function initAway3D():void
		{
			...
			// use this to automatically adjust display size with the window. 
